...
function onClick(event) {
  ...
  const planetText = {
    mercure: {
      title: "Mercury",
      paragraphs: [
        { text: "Paragraph 1 for Mercury...", class: "paragraph1" },
        { text: "Paragraph 2 for Mercury...", class: "paragraph2" },
        { text: "Paragraph 3 for Mercury...", class: "paragraph3" }
      ]
    },
    venus: {
      title: "Venus",
      paragraphs: [
        { text: "Paragraph 1 for Venus...", class: "paragraph1" },
        { text: "Paragraph 2 for Venus...", class: "paragraph2" },
        { text: "Paragraph 3 for Venus...", class: "paragraph3" }
      ]
    },
    terre: {
      title: "Earth",
      paragraphs: [
        { text: "Paragraph 1 for Earth...", class: "paragraph1" },
        { text: "Paragraph 2 for Earth...", class: "paragraph2" },
        { text: "Paragraph 3 for Earth...", class: "paragraph3" }
      ]
    },
    mars: {
      title: "Mars",
      paragraphs: [
        { text: "Paragraph 1 for Mars...", class: "paragraph1" },
        { text: "Paragraph 2 for Mars...", class: "paragraph2" },
        { text: "Paragraph 3 for Mars...", class: "paragraph3" }
      ]
    },
    jupiter: {
      title: "Jupiter",
      paragraphs: [
        { text: "Paragraph 1 for Jupiter...", class: "paragraph1" },
        { text: "Paragraph 2 for Jupiter...", class: "paragraph2" },
        { text: "Paragraph 3 for Jupiter...", class: "paragraph3" }
      ]
    },
    saturne: {
      title: "Saturne",
      paragraphs: [
        { text: "Paragraph 1 for Saturne...", class: "paragraph1" },
        { text: "Paragraph 2 for Saturne...", class: "paragraph2" },
        { text: "Paragraph 3 for Saturne...", class: "paragraph3" }
      ]
    },
    uranus: {
      title: "Uranus",
      paragraphs: [
        { text: "Paragraph 1 for Uranus...", class: "paragraph1" },
        { text: "Paragraph 2 for Uranus...", class: "paragraph2" },
        { text: "Paragraph 3 for Uranus...", class: "paragraph3" }
      ]
    },
    neptune: {
      title: "Neptune",
      paragraphs: [
        { text: "Paragraph 1 for Neptune...", class: "paragraph1" },
        { text: "Paragraph 2 for Neptune...", class: "paragraph2" },
        { text: "Paragraph 3 for Neptune...", class: "paragraph3" }
      ]
    }
  };
  ...
  if (intersects.length > 0) {
    ...
    planetInfo.innerHTML = `<h2>${object.name}</h2>`;

    const paragraphs = planetText[object.name.toLowerCase()].paragraphs;
    paragraphs.forEach((paragraphData) => {
      const planetParagraph = document.createElement('p');
      planetParagraph.textContent = paragraphData.text;
      planetParagraph.classList.add(paragraphData.class);
